	 	        ...
	 	        //voluta personalizzazione nella tabella activity_stay e opzioni_pers
	              ...
	              //CREA TABELLA attivita
	 	        	...
	 	        	pst.executeUpdate();//fine creazione*/
	 			              ...
	 			              //CREA TABELLA attivita_stay
	 	        	create = "CREATE TABLE ATTIVITA_ST("+
	 		 	    		 "idActivityStay INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),"+
	 		  	    		 "idActivity integer not null,"+
	 		 	    		 "idStay integer not null,"+
	 		  	    		 "timeOffset INTEGER not null,"+

	 		  	    		"PRIMARY KEY (idActivityStay),"+	     				
	 	        	...
	 	        	create = "CREATE TABLE opzioni_Standard ("+
	    					...
	    					"foreign key(idOptionList) references OPTION_LIST(idOption))";
	 	        	...
	 	        	create = "CREATE TABLE OPZIONI_PERS("+
	     					...
	     					"PRIMARY key (idOption),"+
	     					"foreign key(idLeaf) references STAYTEMPLATE_LEAF(idSTLeaf)"+
	     					"FOREIGN KEY (idOptionList) REFERENCES option_list(idOption)"+
	     					"foreign key (idST) references stay(idstay))";
